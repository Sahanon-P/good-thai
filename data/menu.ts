...
export interface PriceTag {
  ...
  price: number;
  dinnerPrice?: number;
  /** "lunch" = lunch only, "dinner" = dinner only, omit = show in both */
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: 15,
    priceTag: [
      { title: "Chicken/Beef", price: 15, dinnerPrice: 17 },
      { title: "Fish fillet/Prawns/Seafood", price: 18, dinnerPrice: 20 },
    ],
  ...
  },
  {
    ...
    price: 15,
    priceTag: [
      { title: "Chicken/Beef/Pork", price: 15, dinnerPrice: 17 },
      { title: "Fish fillet/Prawns/Seafood", price: 18, dinnerPrice: 20 },
    ],
  ...
  },
  {
    ...
    priceTag: [
      {
        title: "Vegetables/Tofu/Chicken/Beef/Pork",
        price: 15,
        mealPeriod: "lunch",
      },
      { title: "Combination Meats", price: 16, mealPeriod: "lunch" },
      { title: "Seafood", price: 18, mealPeriod: "lunch" },
      { title: "Vegetables", price: 23, mealPeriod: "dinner" },
      { title: "Chicken/Beef/Pork/Tofu", price: 24, mealPeriod: "dinner" },
      { title: "Combination Meat", price: 25, mealPeriod: "dinner" },
      { title: "Lamb", price: 26, mealPeriod: "dinner" },
      { title: "Seafood/Prawns/Fried Fish", price: 26, mealPeriod: "dinner" },
      { title: "Crispy Chicken", price: 28, mealPeriod: "dinner" },
      { title: "Crispy Pork", price: 28, mealPeriod: "dinner" },
      { title: "Lamb Shank Massaman", price: 28, mealPeriod: "dinner" },
    ],
    ...
    priceTag: [
{
  ...
  },
  {
    ...
    description:
      "Tender BBQ pork and crispy pork served with our special Thai style sauce",
    price: 28,
